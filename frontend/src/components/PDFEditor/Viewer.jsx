  ...
  if (!file) {
    return (
      <div className="flex items-center justify-center p-12 glass-card h-[600px] w-full max-w-4xl mx-auto flex-col gap-5 text-center mt-4">
        <div className="w-20 h-20 rounded-full border border-neutral-700 bg-neutral-800/50 flex items-center justify-center mb-2">
        ...
        <div>
          <h3 className="text-2xl font-extrabold text-neutral-500 mb-2">NO PDF LOADED</h3>
          <p className="text-sm text-neutral-400 font-medium max-w-sm mx-auto">Please upload a document to begin editing. Use the 'Open Local PDF' button in the toolbar above.</p>
        </div>
      </div>
    );
  }
